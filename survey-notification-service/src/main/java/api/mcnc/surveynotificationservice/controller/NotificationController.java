...
public class NotificationController {
    ...
    public ResponseEntity<Long> getUnreadNotificationCount(@RequestHeader(value = "requested-by", required = false) String adminId) {
    ...
    // 관리자의 모든 알림 조회
    @GetMapping
    public ResponseEntity<List<NotificationDto>> getAllNotifications(@RequestHeader(value = "requested-by", required = false) String adminId) {
    ...
    public ResponseEntity<SseEmitter> subscribe(
            @RequestHeader(value = "requested-by", required = false) String adminId) {
    ...
    public ResponseEntity<Void> unsubscribeFromNotifications(@RequestHeader(value = "requested-by", required = false) String adminId) {
    ...
    @PostMapping("/publish")
    public ResponseEntity<Void> publishNotificationToRedis(@RequestBody Request request, @RequestHeader(value = "requested-by", required = false) String adminId) {
